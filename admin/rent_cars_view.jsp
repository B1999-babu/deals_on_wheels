...
<jsp:include page="sidebar.jsp"></jsp:include>
 <div id="page-wrapper" >
   ...
   <!--   Kitchen Sink -->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Rent Cars Details | <a class="btn btn-success" href="rent_cars_form.jsp"><i class="fa fa-plus"></i> Add New</a>
                        </div>
  ...
  <tr>
    ...
    <td><div align="center"><a href="rent_cars_view_photo.jsp?id=<%=rcid%>"><img src="../uploads/<%=rs.getString("car_photo")%>" width="100px" height="100px"/></a></br><a href="rent_cars_select_photo.jsp?rid=<%=rcid%>&pt=up">Change Photo</a></div></td>
    ...
    <td><div align="center"><a href="rent_cars_edit.jsp?id=<%=rcid%>"class="btn btn-success"><i class="fa fa-edit"></i></a>  <a onClick="return confirm('Are you sure?')" href="rent_cars_delete.jsp?id=<%=rcid%>"class="btn btn-danger">X</a> </div></td>
  </tr>
  <%
  }
  %>
