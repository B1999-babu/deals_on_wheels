...
s1=request.getParameter("g_photolink");
 ...
 String saveFile="";
	...
	ResultSet rs=s.stm.executeQuery("select max(c_id) as mid from customer_details");
    rs.next();
    int id=rs.getInt("mid");

//String r=session.getAttribute("r").toString();
	
	int k=s.stm.executeUpdate("update customer_details set c_photo='"+saveFile+"' where c_id='"+id+"'");
