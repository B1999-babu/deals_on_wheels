...
s1=request.getParameter("g_photolink");
 ...
 String saveFile="";
	...
	int k=s.stm.executeUpdate("update car_details set cr_photo1='"+saveFile+"' where cr_id='"+id+"'");
   
    fileOut.close();
	}
	else if(pt.equals("up"))
	{
	int k=s.stm.executeUpdate("update car_details set cr_photo1='"+saveFile+"' where cr_id='"+cid+"'");
...
document.location="car_details_select_photo2.jsp";
</script>
<% } %>