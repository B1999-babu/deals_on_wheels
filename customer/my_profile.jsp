...
<input name="cid" type="hidden" value="<%=rs.getInt("c_id")%>">
     ...
     <div><label>First Name</label>
      ...
      <input  class="validate[required,custom[onlyLetter]] form-control" style="width:90%" name="ln" value="<%=rs.getString("c_lname")%>"type="text" id="ln"> 
       ...
       <input  class="validate[required,custom[email]] form-control" style="width:90%" readonly="" name="ei" value="<%=rs.getString("c_email")%>" type="text" id="ei"> 
   </div><br>
