    ...
    <section id="about" class="clients">
        <div class="container">
            ...
            <div class="car-img mx-0 text-center px-lg-5">
                <img src="wfs_temp/web/assets/images/1.png" alt="" class="img-fluid">
            </div>
            ...
            <div class="row no-gutters">
                <div class="content col-xl-5 d-flex align-items-stretch">
                    <div class="content">
                        ...
                        <h3 class="title-w3l two">Happiness</h3>
                        <p>
                            The pain itself is the love of the pain, the main ecological problems, but I give this kind of time to fall down, so that some great pain and pain. The pain is to blame
                        </p>
                    ...
                    <div class="box-wrap">
                        <div class="box-wrap-grid">
                            ...
                            <div class="info">
                                ...
                                <p class="mt-3">Get the lowest rental cars here</p>
                            </div>
                        </div>
                    ...
                    <div class="box-wrap">
                        <div class="box-wrap-grid">
                            ...
                            <div class="info">
                                ...
                                <p class="mt-3">Enjoy your holidays with our wheels </p>
                            </div>
                    ...
                    <div class="box-wrap">
                        <div class="box-wrap-grid">
                            ...
                            <div class="info">
                                ...
                                <p class="mt-3">Cancellation process is free. </p>
                            </div>
                        </div>
                    ...
                    <div class="box-wrap">
                        <div class="box-wrap-grid">
                            ...
                            <div class="info">
                                ...
                                <p class="mt-3">Best services with the best work</p>
                            </div>
                        </div>
                        ...
                        <div class="box-wrap-grid">
                            ...
                            <div class="info">
                                <h4><a href="#url">
                                        ...
                                        Award winning</a></h4>
                                <p class="mt-3"> Dedication + Motivation = success. </p>
                            </div>
                        </div>
                    ...
                    <div class="box-wrap">
                        <div class="box-wrap-grid">
                            ...
                            <div class="info">
                                ...
                                <p class="mt-3">A Customer Service is our Attitude </p>
                            </div>
                        </div>
            ...
            <div class="row team-row">
                ...
                <div class="col-lg-4 col-sm-6 team-wrap mt-lg-5 mt-4">
                    <div class="team-member last text-center">
                        <div class="team-img">
                            <img src="wfs_temp/web/assets/images/team1.jpg" alt="" class="img-fluid radius-image">
                            <div class="overlay">
                ...
                <div class="col-lg-4 col-sm-6 team-wrap mt-lg-5 mt-4">
                    <div class="team-member last text-center">
                        <div class="team-img">
                            <img src="wfs_temp/web/assets/images/team2.jpg" alt="" class="img-fluid radius-image">
                            <div class="overlay">
                                <div class="team-details text-center">
                                    <p>
                                        Our web design team will spend time with our digital marketing team.
                ...
                <div class="col-lg-4 col-sm-6 team-wrap mt-lg-5 mt-4">
                    <div class="team-member last text-center">
                        <div class="team-img">
                            <img src="wfs_temp/web/assets/images/team4.jpg" alt="" class="img-fluid radius-image">
                            <div class="overlay">
                                <div class="team-details text-center">
                                    <p>
                                        Our web design team will spend time with our digital marketing team.
                    ...
                    <div class="owl-two owl-carousel owl-theme row">
                            ...
                            <div class="card">
                                <div class="card-header p-0 position-relative">
                                    <a href="#cardblog" class="zoom d-block">
                                        <img class="card-img-bottom d-block" src="wfs_temp/web/assets/images/g1.jpg" alt="Card image cap">
                                    </a>
                                </div>
                       ...
                       <div class="item col-lg-4 col-md-6 mt-lg-5 mt-4">
                            <div class="card">
                                <div class="card-header p-0 position-relative">
                                    <a href="#cardblog" class="zoom d-block">
                                        <img class="card-img-bottom d-block" src="wfs_temp/web/assets/images/g2.jpg" alt="Card image cap">
                                    </a>
                       ...
                       <div class="item col-lg-4 col-md-6 mt-lg-5 mt-4">
                            <div class="card">
                                <div class="card-header p-0 position-relative">
                                    <a href="#cardblog" class="zoom d-block">
                                        <img class="card-img-bottom d-block" src="wfs_temp/web/assets/images/g3.jpg" alt="Card image cap">
                                    </a>
                                </div>
                                <div class="card-body course-details">
                                    <a href="#cardblog" class="course-desc">Lorem ipsum dolor sit
            ...
            <ul class="gallery_agile mt-4">
                <li>
                    <div class="w3_agile_portfolio_grid">
                        <a href="#">
                            <img src="wfs_temp/web/assets/images/g1.jpg" alt=" " class="img-fluid radius-image" />
                    ...
                    <div class="w3_agile_portfolio_grid mt-4">
                         <a href="#">
                            <img src="wfs_temp/web/assets/images/g2.jpg" alt=" " class="img-fluid radius-image" />
                            <div class="w3layouts_news_grid_pos">
                                <div class="wthree_text">
                                    <h3><i class="fas fa-search"></i></h3>
                                </div>
                ...
                <li>
                    <div class="w3_agile_portfolio_grid">
                        <a href="#">
                            <img src="wfs_temp/web/assets/images/g3.jpg" alt=" " class="img-fluid radius-image" />
                            <div class="w3layouts_news_grid_pos">
                                <div class="wthree_text">
                                    <h3><i class="fas fa-search"></i></h3>
                                </div>
                    ...
                    <div class="w3_agile_portfolio_grid mt-4">
                         <a href="#">
                            <img src="wfs_temp/web/assets/images/g4.jpg" alt=" " class="img-fluid radius-image" />
                            <div class="w3layouts_news_grid_pos">
                                <div class="wthree_text">
                                    <h3><i class="fas fa-search"></i></h3>
                                </div>
                ...
                <li>
                    <div class="w3_agile_portfolio_grid">
                        <a href="#">
                            <img src="wfs_temp/web/assets/images/g5.jpg" alt=" " class="img-fluid radius-image" />
                            <div class="w3layouts_news_grid_pos">
                                <div class="wthree_text">
                                    <h3><i class="fas fa-search"></i></h3>
                                </div>
                    ...
                    <div class="w3_agile_portfolio_grid mt-4">
                        <a href="#">
                            <img src="wfs_temp/web/assets/images/g6.jpg" alt=" " class="img-fluid radius-image" />
                            <div class="w3layouts_news_grid_pos">
                                <div class="wthree_text">
                                    <h3><i class="fas fa-search"></i></h3>
                                </div>
    ...
    <section id="contact" class="contact">
     ...
     data-aos-duration="3000">
                                ...
                                <div class="cont-right">
                                    ...
                                    <p>Work flow softwares,near bus stand,sankeshwar-591313</p>
                                </div>
                            </div>
     ...
     data-aos-duration="3000">
                                ...
                                <div class="cont-right">
                                    <h6>Call Us</h6>
                                    <p><a href="tel:9663893014">9663893014</a></p>
     ...
     data-aos-duration="3000">
                                ...
                                <div class="cont-right">
                                    <h6>Email Us</h6>
                                    <p><a href="mailto:example@mail.com" class="mail">baburaodoog400@mail.com</a></p>
